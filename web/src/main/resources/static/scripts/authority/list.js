...
function fillData(data) {
    ...
    $.each(data, function (k, v) {
        ...
        html += '<tr> ' +
            ...
            '<td>' + (v.authorityName == null ? '' : v.authorityName) + '</td>' +
            '<td>' + (v.authorityDesc == null ? '' : v.authorityDesc) + '</td>' +
            buildHtml(v.resources) +
            ...
            '<td>' + (v.updateTime == null ? '' : getSmpFormatDateByLong(v.updateTime, true)) + '</td><td>';
        if (editrole == 'true')
