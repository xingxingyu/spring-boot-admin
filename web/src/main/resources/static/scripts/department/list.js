...
function fillData(data){
    ...
    $.each(data,function(k,v){
        ...
        html += '<td>' +
        '<a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="showDetail(\''+ v.id+'\')">查询</a>' +
        '<a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="edit(\''+ v.id+'\')">修改</a>' +
        '<a class="c-50a73f mlr-6" href="javascript:void(0)" onclick="del(\''+ v.id+'\')">删除</a>' +
        '</td>';
        html +='</tr>' ;
